...
class Connection
{
    ...
    public function __construct($server, $socket, $application, $player)
    {
        $this->server = $server;
        $this->socket = $socket;
	 ...
	 */
        ...
        $this->application->addClient($this);
    ...
    public function onData($data)
    {
	    ...
	    $welcomeMessage = new WelcomePlayerMessage($this->player->ID);
	    $this->send($welcomeMessage->serialize());
	    $playerListMessage = new PlayerListMessage($this->server->players);
	    $this->send($playerListMessage->serialize());
        }
    }
